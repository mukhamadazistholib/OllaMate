...
export const personas = { OllaMate: 'You are OllaMate, a friendly web assistant' };

const defaultConfig = { personas, generateTitle: true, backgroundImage: true, persona: 'OllaMate', webMode: 'brave', webLimit: 10, contextLimit: 10 };
